...
function loadData(data) {
    ...
    for (var i = 0; i < data.stocks_pg2.length; i++) {
      let ticker = data.stocks_pg2[i].ticker;
      let openPrice = data.stocks_pg2[i].results[0].o;
      let highPrice = data.stocks_pg2[i].results[0].h;
      let lowPrice = data.stocks_pg2[i].results[0].l;
      let closePrice = data.stocks_pg2[i].results[0].c;
      let logo = data.stocks_pg2[i].logo_url;
